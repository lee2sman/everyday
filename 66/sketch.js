...
function setup(){
  ...
  song = loadSound('assets/dir.mp3',startButton);
  faceImg = loadImage('assets/light.jpg',function(){faceReady = true;});
  ...
  coneModel = loadModel('assets/traffic_cone.obj',true,function(){
    noseTexture = loadImage('assets/lee2.jpg',function(){
      coneReady = true;
    })
  });
  bangsModel = loadModel('assets/bangs.obj', true, function(){
    bangsTexture = loadImage('assets/lee2.jpg',function(){
      bangsReady = true;});
    })
  mic = new p5.AudioIn()
